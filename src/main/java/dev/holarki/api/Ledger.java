 ...
 * maintained by server operators.
 *
 ...
 * rewards, etc.) without building direct database integrations.
 *
 * <h2>Stability</h2>
 *
...
public interface Ledger {
   ...
   *     identifiers while operator automation or server-run jobs may supply a stable workflow id
   *     (required, {@literal <=} 64)
